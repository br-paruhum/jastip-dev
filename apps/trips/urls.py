...
urlpatterns = [
    ...
    path("orders/<int:pk>/change-rate/", views.carrier_change_rate, name="carrier_change_rate"),
    path("orders/<int:pk>/rate-decision/", views.buyer_rate_decision, name="buyer_rate_decision"),
